console.log('%c    PoliPhaser - Version 0.7    ', 'background: #728FA5; color: white; font-size:20px;');
...
PP.shapes.rectangle_add = function(scene, x, y, width, height, fill_color, fill_alpha) {
    ...
    let ret_obj = {ph_obj: rect, visibility : new __PP_internal_getset_obj_visibility(rect)};
    ret_obj.ph_obj.backprop_obj = ret_obj;
...
PP.shapes.arc_add = function(scene, x, y, radius, start_angle, end_angle, anticlockwise, fill_color, fill_alpha) {
    ...
    let ret_obj = {ph_obj: arc, visibility : new __PP_internal_getset_obj_visibility(arc)};
    ret_obj.ph_obj.backprop_obj = ret_obj;
    return ret_obj;
}
...
PP.shapes.polygon_add = function(scene, x, y, points, fill_color, fill_alpha) {
    ...
    let ret_obj = {ph_obj: polygon, visibility : new __PP_internal_getset_obj_visibility(polygon)};
    ret_obj.ph_obj.backprop_obj = ret_obj;
    return ret_obj;
