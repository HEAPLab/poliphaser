...
PP.assets.image.add = function(scene, image, x, y, pivot_x, pivot_y) {
    ...
    let ret_obj = {ph_obj: temp_image, orig_image : image, geometry : new __PP_internal_getset_obj_geometry(temp_image)};
...
PP.assets.sprite.add = function(scene, sprite, x, y, pivot_x, pivot_y) {
    ...
    let ret_obj =  {ph_obj: temp_image, orig_sprite : sprite, list_of_animations : [], geometry : new __PP_internal_getset_obj_geometry(temp_image)};
    ret_obj.ph_obj.backprop_obj = ret_obj;
    return ret_obj;
}
...
PP.assets.tilesprite.add = function(scene, image, x, y, width, height, pivot_x, pivot_y) {
    ...
    let ret_obj = {ph_obj: temp_ts, orig_image : image, geometry : new __PP_internal_getset_obj_geometry(temp_ts),
...
PP.assets.destroy = function(obj) {
    ...
    PP.debug.assert(typeof obj.ph_obj === "object", "Parameter error: obj is not a valid shape instance.");
...
PP.physics.add_collider_f = function(s, obj1, obj2, func) {
    ...
    s.physics.add.collider(obj1.ph_obj, obj2.ph_obj, (a,b)=>{func(s,a.backprop_obj,b.backprop_obj)});
}
...
PP.physics.add_overlap_f = function(s, obj1, obj2, func) {
    ...
    s.physics.add.overlap(obj1.ph_obj, obj2.ph_obj, (a,b)=>{func(s,a.backprop_obj,b.backprop_obj)});
}
