...
/**
 * Add and position a new image in the scene. TODO: Documentation
 * @function add_image
 * @memberof PP.assets
...
PP.assets.sprite.add = function(scene, sprite, x, y, pivot_x, pivot_y) {
    ...
    PP.debug.assert(typeof sprite.type === "sprite", "Parameter error: sprite is an object but not a sprite.");
    PP.debug.assert(typeof x === "number", "Parameter error: x should be a number.");
    PP.debug.assert(typeof y === "number", "Parameter error: y should be a number.");
    PP.debug.assert(typeof pivot_x === "number", "Parameter error: pivot_x should be a number.");
    PP.debug.assert(typeof pivot_y === "number", "Parameter error: pivot_y should be a number.");
...
PP.assets.sprite.add_animation = function(scene, sprite_instance, animation_name, frame_start_nr, frame_end_nr, frame_rate, repeat) {
    PP.debug.assert(typeof scene                       === "object", "Parameter error: scene should be a scene object.");
    ...
    PP.debug.assert(typeof animation_name === "string", "Parameter error: animation name is not a string.");
    ...
    sprite_instance.ph_obj.anims.create({
        key: animation_name,
        frames: this.anims.generateFrameNumbers(sprite_instance.orig_sprite.id, {
