...
console.log('%c    PoliPhaser - Version 0.1    ', 'background: #728FA5; color: white; font-size:20px;');
...
class __PP_internal_getset_obj_position {
...
/**
 * The namespace containing the list of possible keycodes for the keyboard. The list
 * is the following: A, ALT, B, BACK_SLASH, BACKSPACE, BACKTICK, BRACKET_LEFT_FIREFOX, BRACKET_RIGHT_FIREFOX, C, CAPS_LOCK, CLOSED_BRACKET, COLON, COMMA, COMMA_FIREFOX, COMMA_FIREFOX_WINDOWS, CTRL, D, DELETE, DOWN, E, EIGHT, END, ENTER, ESC, F, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, FIVE, FORWARD_SLASH, FOUR, G, H, HOME, I, INSERT, J, K, L, LEFT, M, MINUS, N, NINE, NUMPAD_ADD, NUMPAD_EIGHT, NUMPAD_FIVE, NUMPAD_FOUR, NUMPAD_NINE, NUMPAD_ONE, NUMPAD_SEVEN, NUMPAD_SIX, NUMPAD_SUBTRACT, NUMPAD_THREE, NUMPAD_TWO, NUMPAD_ZERO, O, ONE, OPEN_BRACKET, P, PAGE_DOWN, PAGE_UP, PAUSE, PERIOD, PLUS, PRINT_SCREEN, Q, QUOTES, R, RIGHT, S, SEMICOLON, SEMICOLON_FIREFOX, SEVEN, SHIFT, SIX, SPACE, T, TAB, THREE, TWO, U, UP, V, W, X, Y, Z, ZERO,  * @namespace
 * @memberof PP
 */
PP.keycodes = Phaser.Input.Keyboard.KeyCodes;
...
PP.assets.image.add = function(scene, image, x, y, pivot_x, pivot_y) {
    ...
    return {ph_obj: temp_image, orig_image : image, position : new __PP_internal_getset_obj_position(temp_image)};
}
...
PP.assets.sprite.add = function(scene, sprite, x, y, pivot_x, pivot_y) {
    ...
    return {ph_obj: temp_image, orig_sprite : sprite, list_of_animations : [], position : new __PP_internal_getset_obj_position(temp_image)};
}
