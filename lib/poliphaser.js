 ...
 * @param {key_code}    key_code  One of the key codes of PP.KeyCodes. 
...
PP.interactive.kb.is_key_down = function(scene, key_code) {
    ...
    PP.debug.assert(Object.values(PP.KeyCodes).includes(key_code), "Parameter error: key_code is invalid.");
